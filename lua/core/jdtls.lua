local masonpkgpath = "/home/baileybuns/.local/share/nvim/mason/packages/"

local function get_jdtls()
    -- /home/baileybuns/.local/share/nvim/mason/packages/jdtls/plugins/org.eclipse.equinox.launcher_1.7.0.v20250331-1702.jar

    -- local mason_registry = require("mason-registry")
    -- local jdtls = mason_registry.get_package("jdtls")
    -- local jdtls_path = jdtls.get_install_path()
    local jdtls_path = masonpkgpath .. "jdtls"
    -- Obtain the path to the jar which runs the language sever
...
local function get_bundles()
    ...
    local java_debug_path = masonpkgpath .. "java_debug_adapter"
    ...
    local java_test_path = masonpkgpath .. "java-test"
